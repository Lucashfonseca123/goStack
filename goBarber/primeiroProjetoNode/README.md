...
- O usuário não pode alterar seu email para um email ja atualizado;
...
- Os agendamentos devem estar disponíveis entre as 8h as 18h (Primeiro às 8h, último às 17h);
